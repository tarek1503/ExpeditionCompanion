...
public class VoyageController {
	...
	@ResponseBody
	public String ajoutervoyage(@RequestBody Voyage voyage/*, @RequestParam("image") MultipartFile picture*/)
			throws IOException {
...
*/
	...
	@GetMapping("/listeemployee/{idVoyage}")
	@ResponseBody
	public List<User> GetEmployeeOfVoyage(@PathVariable("idVoyage") int idVoyage) {
		return voyageService.GetEmployeeOfVoyage(idVoyage);
	}
